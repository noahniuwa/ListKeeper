...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(List, [{
    ...
    value: function componentDidMount() {
      ...
      var quill = new Quill("#".concat(this.props.editorId), {
        theme: 'snow'
      });
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        onDragOver: function onDragOver() {
          return _this3.onDragOver(event);
        },
        onDragStart: function onDragStart() {
          return _this3.drag(event);
        },
        draggable: "true",
        id: this.props.id,
        ...
        onClick: function onClick(e) {
          ...
          _this3.props.deleteList(_this3.props.id);
        },
...
//# sourceMappingURL=index.js.27805283adeeb505f47a.hot-update.js.map